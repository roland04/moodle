...
Feature: Edit activities in main menu block
  ...
  @javascript
  Scenario: Teacher can delete an activity in the main menu block
    Given the following "activity" exists:
      | activity | forum                |
      | course   | Acceptance test site |
      | name     | My forum name        |
  ...
  @javascript
  Scenario: Teacher can duplicate an activity in the main menu block
    Given the following "activity" exists:
      | activity | forum                |
      | course   | Acceptance test site |
      | name     | My forum name        |
  ...
  @javascript
  Scenario: Teacher can move right and left an activity in the main menu block
    Given the following "activity" exists:
      | activity | forum                |
      | course   | Acceptance test site |
      | name     | My forum name        |
